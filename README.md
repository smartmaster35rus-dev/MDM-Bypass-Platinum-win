...
Windows-инструмент для обхода MDM-профиля (Mobile Device Management) на iPhone и iPad.
...
<p align="center">
  <img src="screenshot.png" alt="MDM Bypass Platinum" width="800"/>
</p>

## Возможности

- **Обход MDM-профиля** — удаление корпоративного управления и ограничений
...
3. Запустите MDM Bypass Platinum
4. Дождитесь определения устройства
5. Нажмите **MDM BYPASS START**
